...
function HeroesComponent_div_10_li_2_Template(rf, ctx) { if (rf & 1) {
...
HeroesComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: HeroesComponent, selectors: [["app-heroes"]], viewQuery: function HeroesComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, decls: 12, vars: 3, consts: [[1, "heroes_container"], [1, "flex"], ["type", "text", "dtInput", "", "placeholder", "Please add hero name", 1, "hero_input"], ["heroName", ""], [1, "inline-flex", "button-item", 3, "click"], [1, "add-icon"], ["name", "plus-add"], ["class", "heroes", 4, "ngIf"], ["name", "dropdownopen", 1, "scroll", 3, "click"], [1, "heroes"], ["heroesContainer", ""], [4, "ngFor", "ngForOf"], [3, "routerLink"], [1, "badge"], [1, "name"], ["title", "delete hero", 1, "delete", 3, "click"]], template: function HeroesComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function HeroesComponent_Template_dt_icon_click_11_listener() { return ctx.toggleScroll(); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
